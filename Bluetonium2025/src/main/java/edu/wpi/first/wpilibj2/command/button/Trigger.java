 ...
 *
 * <p>
 * Spectrum modified in Fall 2024 to allow triggers to default start condition
 * of false, so if
 * something is already true when bound it will activate the trigger. We needed
 * this for a trigger
...
public class Trigger implements BooleanSupplier {
    ...
    /**
     * Run a command while true. Also runs a command for a certain timeout when
     * released.
     *
     * @param trigger
     * @param runCommand
     ...
     * @return a new Trigger that represents the logical AND of all provided
     *         triggers.
     */
     ...
     *
     * @param triggers an array of BooleanSupplier triggers to be combined.
     * @return a new NewTrigger instance that represents the logical OR of the
     *         provided triggers.
     */
