...
public class LimelightConstants {
    public static final LimelightConfig UPPER_LL = new LimelightConfig("limelight-upper",
    ...
    public static final LimelightConfig LOWER_LEFT_LL = new LimelightConfig("limelight-lleft",
    ...
    public static final LimelightConfig LOWER_RIGHT_LL = new LimelightConfig("limelight-lright",
            new Translation3d(Units.inchesToMeters(8), Units.inchesToMeters(-10.5), Units.inchesToMeters(10.5)),
            new Rotation3d(0, 10, Math.toRadians(20)));
